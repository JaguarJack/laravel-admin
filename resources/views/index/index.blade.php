...
<head>
    ...
    <meta name="keywords" content="laravel, 后台 , package">
    <meta name="description" content="Laravel Admin Is A Package Of Laravel！">
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">{{ $menu->name }}</span>
                             @if(isset($menu->children))<span class="fa arrow"></span>@endif
                        </a>
                        <ul class="nav nav-second-level">
                        @if(isset($menu->children))
                        	@foreach ($menu->children as $child)
                            <li>
                                <a class="J_menuItem" href='{{ url("$child->url") }}' data-index="0">
                                    @if ($child->icon)
                                	<i class="{{ $menu->icon }}"></i>
                                	@endif
                                	{{ $child->name }}
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
             ...
             <div class="row J_mainContent" id="content-main">
            	<iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="{{ url('index/main') }}" frameborder="0" data-id="{{ url('index/main') }}" seamless></iframe>
        	 </div>
            <div class="footer">
                <div class="pull-right">&copy; 2018-2019 <a href="http://www.njphper.com/" target="_blank">Laravel Admin</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
    ...
    <script src="{{ asset('/assets/js/plugins/layer/layer.min.js') }}"></script>
    <script src="{{ asset('/assets/js/hplus.min.js?v=4.0.0') }}"></script>
    <script type="text/javascript" src="{{ asset('/assets/js/contabs.min.js') }}"></script>
